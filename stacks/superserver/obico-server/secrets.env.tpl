...
DJANGO_SECRET_KEY="op://Komodo/Obico-Server/Django Secret Key"
...
EMAIL_HOST_USER="op://Komodo/Obico-Server/Email/User"
# Such as your email address for a Gmail account

EMAIL_HOST_PASSWORD="op://Komodo/Obico-Server/Email/Password"
