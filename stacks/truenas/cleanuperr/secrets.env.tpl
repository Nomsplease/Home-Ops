...
# job triggers
TRIGGERS__QUEUECLEANER=0 0/1 * * * ?
TRIGGERS__CONTENTBLOCKER=0 0/1 * * * ?
...
# failed imports
QUEUECLEANER__IMPORT_FAILED_MAX_STRIKES=12
QUEUECLEANER__IMPORT_FAILED_IGNORE_PATTERNS__0=title mismatch
QUEUECLEANER__IMPORT_FAILED_IGNORE_PATTERNS__1=manual import required

# stalled downloads
QUEUECLEANER__STALLED_MAX_STRIKES=12
QUEUECLEANER__STALLED_RESET_STRIKES_ON_PROGRESS=true

# slow downloads
QUEUECLEANER__SLOW_MAX_STRIKES=12
